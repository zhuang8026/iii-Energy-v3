...
axios.interceptors.response.use((response) => {
  ...
  if (res.code !== 200) {
    if (
        res.code === 411 || res.code === 412
        || res.code === 413 || res.code === 414
        || res.code === 415 || res.code === 416
        || res.code === 417 || res.code === 418
        || res.code === 419 || res.code === 420
        || res.code === 421 || res.code === 4000
        || res.code === 4001|| res.code === 4002
    ) {
